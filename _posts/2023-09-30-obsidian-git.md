...
description: 옵시디언 깃을 이용하여 기기간의 데이터를 동기화 하는 방법에 대해 알아봅니다.
date: 2023-09-30
---
...
![](/assets/img/2023-09-30-obsidian-git/1.png)
Obsidian 을 열고 `Create new vault`에서 `Create` 버튼을 클릭해줍니다.

![](/assets/img/2023-09-30-obsidian-git/2.png)
`Vault name`과 `Location` 설정 후, `Create` 버튼을 클릭해줍니다.

![](/assets/img/2023-09-30-obsidian-git/57.png)
생성된 볼트에 새 노트를 하나 작성해줍니다.

![](/assets/img/2023-09-30-obsidian-git/58.png)
이후 `Preference > Community plugins`로 이동하여 `Turn on community plugins` 버튼을 클릭해줍니다.

![](/assets/img/2023-09-30-obsidian-git/59.png)
`Community plugins`의 `Browse` 버튼을 클릭해줍니다.

![](/assets/img/2023-09-30-obsidian-git/60.png)
검색창에 `Obsidian Git` 입력 후 선택해줍니다.

![](/assets/img/2023-09-30-obsidian-git/61.png)
`Install` 버튼 클릭하여 플러그인을 설치해줍니다.

![](/assets/img/2023-09-30-obsidian-git/62.png)
설치 완료 후 `Enable` 클릭하여 플러그인을 활성화해줍니다.

![](/assets/img/2023-09-30-obsidian-git/63.png)
...
![](/assets/img/2023-09-30-obsidian-git/3.png)
프로필에서 좌측 상단의 `Repositories` 탭을 클릭해줍니다.

![](/assets/img/2023-09-30-obsidian-git/4.png)
우측 상단 `New` 버튼을 클릭하여 새 레포지토리 생성 페이지로 이동해줍니다.

![](/assets/img/2023-09-30-obsidian-git/5.png)
아래 3가지 정보를 입력해주세요.
...
![](/assets/img/2023-09-30-obsidian-git/8.png)
...
![](/assets/img/2023-09-30-obsidian-git/14.png)
Github 우측 상단의 프로필을 클릭하고 `Settings` 를 클릭해주세요.

![](/assets/img/2023-09-30-obsidian-git/15.png)
좌측 하단의 `Developer settings` 클릭해주세요.

![](/assets/img/2023-09-30-obsidian-git/16.png)
`Personal access tokens > Tokens (classic)` 을 클릭해주세요.

![](/assets/img/2023-09-30-obsidian-git/17.png)
우측 상단의 `Generate new token > Generate new token (classic)` 를 클릭해주세요.

![](/assets/img/2023-09-30-obsidian-git/18.png)
Github 계정 비밀번호를 입력해줍니다.

![](/assets/img/2023-09-30-obsidian-git/19.png)
다음 세 가지를 입력해줍니다.
...
![](/assets/img/2023-09-30-obsidian-git/20.png)
하단의 `Generate token`을 클릭하여 토큰을 생성합니다.

![](/assets/img/2023-09-30-obsidian-git/21.png)
그러면 이런식으로 토큰이 생성됩니다.
...
![](/assets/img/2023-09-30-obsidian-git/22.png)
이후 위 토큰을 터미널의 `Password` 입력란에 입력하면 Push 가 완료됩니다.

![](/assets/img/2023-09-30-obsidian-git/23.png)
Push 가 완료되면 Github 레포지토리에 작성한 Obsidian 파일들이 백업된 것을 확인하실 수 있습니다.

![](/assets/img/2023-09-30-obsidian-git/24.png)
이후 노트를 수정한 뒤

![](/assets/img/2023-09-30-obsidian-git/25.png)
좌측의 `Open command palette` 버튼을 클릭합니다.

![](/assets/img/2023-09-30-obsidian-git/26.png)
검색창에 `Obsidian Git: Open source control view` 를 입력하고 실행합니다.

![](/assets/img/2023-09-30-obsidian-git/27.png)
Git 뷰에서 상단의 우측에서 3번째 `Pull` 버튼을 클릭합니다.

![](/assets/img/2023-09-30-obsidian-git/28.png)
그러면 `Changes` 에 변경된 파일 내역이 노출됩니다.

![](/assets/img/2023-09-30-obsidian-git/29.png)
이후, Git 뷰에서 상단의 좌측에서 첫번째 백업 버튼을 눌러 변경사항을 저장합니다.

![](/assets/img/2023-09-30-obsidian-git/56.png)
백업 진행 시, 우측 상단에 이러한 메시지가 노출되며 Commit/Push가 자동으로 진행됩니다.

![](/assets/img/2023-09-30-obsidian-git/30.png)
...
![](/assets/img/2023-09-30-obsidian-git/34.png)
아이폰에 Obsidian 앱을 설치 후, `Create New Vault` 를 통해 새 볼트를 생성합니다.

![](/assets/img/2023-09-30-obsidian-git/35.png)
...
![](/assets/img/2023-09-30-obsidian-git/36.png)
이후 PC 에서 볼트가 저장된 디렉토리를 아이폰으로 전송해야 합니다. 어떠한 방법을 사용하셔도 무방하지만 필자는 `에어드랍` 을 이용하였습니다.

![](/assets/img/2023-09-30-obsidian-git/37.png)
이런 식으로 PC 의 Obsidian 볼트 디렉토리를 아이폰의 Obsidian 볼트 디렉토리가 있는 위치에 그대로 덮어씌워주세요.

![](/assets/img/2023-09-30-obsidian-git/38.png)
그럼 이렇게 PC 에서 작성 한 노트가 복사되어 옮겨진 것을 확인하실 수 있습니다.

![](/assets/img/2023-09-30-obsidian-git/39.png)
이후 좌측 상단의 탭 버튼을 눌러 좌측 탭을 열어주고 탭 우측 상단의 설정 버튼을 눌러줍니다.

![](/assets/img/2023-09-30-obsidian-git/40.png)
`Community plugins` 를 눌러줍니다.

![](/assets/img/2023-09-30-obsidian-git/41.png)
`Turn on community plugins` 버튼을 눌러줍니다.

![](/assets/img/2023-09-30-obsidian-git/42.png)
`Browse` 버튼을 눌러줍니다.

![](/assets/img/2023-09-30-obsidian-git/43.png)
`Obsidian Git` 플러그인을 검색해줍니다.

![](/assets/img/2023-09-30-obsidian-git/44.png)
`Install` 해주고, `Enable` 해줍니다.

![](/assets/img/2023-09-30-obsidian-git/45.png)
이후 다시 설정 화면으로 돌아와 최하단의 `Community plugins > Obsidian Git` 을 눌러줍니다.

![](/assets/img/2023-09-30-obsidian-git/52.png)
...
![](/assets/img/2023-09-30-obsidian-git/47.png)
이후 메인화면으로 돌아와 하단 탭의 메뉴 버튼을 누르고 `Open command palette` 를 눌러주세요.

![](/assets/img/2023-09-30-obsidian-git/48.png)
마찬가지로 `Obsidian Git: Open source control view` 를 입력하고 실행합니다.

![](/assets/img/2023-09-30-obsidian-git/49.png)
그러면 이렇게 우측 탭에 Git 뷰가 나타납니다. 이후에는 우측 부분을 슬라이드 하여 우측 탭을 열 수 있습니다.

![](/assets/img/2023-09-30-obsidian-git/50.png)
이제 이렇게 노트를 수정하면

![](/assets/img/2023-09-30-obsidian-git/51.png)
마찬가지로 Git 뷰의 `Changes` 부분에서 변경 내역을 확인하실 수 있습니다.

![](/assets/img/2023-09-30-obsidian-git/53.png)
이후, 마찬가지로 Git 뷰에서 백업 버튼을 눌러 변경사항을 저장합니다.

![](/assets/img/2023-09-30-obsidian-git/54.png)
그러면 이런 식으로 토스트 메시지가 노출되며 Push 가 정상적으로 동작함을 확인할 수 있습니다.

![](/assets/img/2023-09-30-obsidian-git/31.png)
이제 다시 PC 의 Git 뷰에서 `Pull` 버튼을 눌러주면

![](/assets/img/2023-09-30-obsidian-git/32.png)

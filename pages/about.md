...
<div class="profile-container">
  ...
  <div class="profile-text">
    ...
    <p>웹 개발을 주로하며 FE파트 리딩까지 경험이 있습니다.</p>
...
<div class="content-section">
  ...
  <ul class="simple-list">
    <li>React, React Native, Typescript, Webpack, SCSS</li>
    <li>Claude Code, Codex, Cursor, Gemini</li>
  </ul>
</div>
...
<div class="content-section">
  ...
  <div class="content-item">
    ...
    <p class="item-subtitle">2021.08-2025.10 | <strong>Developer</strong></p>
    ...
    <div class="sub-item">
      ...
      <ul class="simple-list">
        <li>Vite, React, Typescript, SCSS, TanStack Query(React Query), ESLint, Prettier</li>
        <li>모바일은 배포 리스크 감소 및 공통 디자인 시스템 사용을 위해 React Native 기반의 웹앱으로 구현</li>
        <li>중첩 코드 공통화를 위해 MonoRepo 방식으로 프로젝트 구축</li>
        <li>AI 기술을 실무에 더 잘 적용하기 위한 방법을 집중 연구 및 도입중
          <ul class="nested-list">
            <li>Cursor IDE 의 Rules 파일을 고도화하여 AI 에게 프로젝트의 맥락을 깊게 이해시킴과 동시에 코드와 도메인에 대한 전체적이고 자세한 설명을 프로젝트 내에서 지속 관리할 수 있도록 작성</li>
    ...
    <div class="sub-item">
      ...
      <ul class="simple-list">
        <li>React Native, Typescript, styled-components, TanStack Query(React Query), ESLint, Prettier</li>
        <li>배포 리스크를 줄이고 신속한 배포를 위해 Code Push 배포 시스템 구축</li>
        <li>Node.js 로 구축된 백엔드와 프론트엔드 간 데이터 모델 일관성을 위해 공용 레포를 생성하고 npm 에 배포해 사용</li>
      </ul>
    </div>
    ...
    <div class="sub-item">
      ...
      <p class="sub-item-desc">잡다에 등록 된 구직자들중 기업이 원하는 조건의 인재를 매칭해주고 검증/평가를 도와 쉽게 인재를 채용할 수 있도록 돕는 ATS 서비스</p>
      <ul class="simple-list">
        <li>Next.js, TypeScript, Scss, Mobx, Eslint, Prettier, Stylelint</li>
  ...
  <div class="content-item">
    ...
    <div class="sub-item">
      ...
      <ul class="simple-list">
        <li>Webpack, React, Less, Mobx, ESLint, Prettier</li>

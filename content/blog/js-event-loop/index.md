...
**자바스크립트**는 **싱글 스레드 기반의 프로그래밍 언어**로 한번에 하나의 일만 처리 할 수 있습니다.
...
![](content/blog/js-event-loop/1.png)

![](content/blog/js-event-loop/2.png)
...
![](content/blog/js-event-loop/10.png)
...
![](content/blog/js-event-loop/11.png)
